...
class DialogManager:
    ...
    def show_settings_dialog(
        ...
        self.api_key_field.value = current_api_key or ""
        self.api_key_field.on_change = lambda e: persist_change("GEMINI_API_KEY", (self.api_key_field.value or "").strip())
        self.api_key_field.on_blur = lambda e: persist_change("GEMINI_API_KEY", (self.api_key_field.value or "").strip())
                ...
                tab_container.content = ft.Column([
                    ...
                    ft.Row([
                        ...
                        ft.Button(
                            ...
                            on_click=lambda e: self.show_reset_settings_confirm(
                                on_confirm=lambda: (
        ...
        self.settings_dialog.actions = [
            ft.TextButton(
                "Close",
                icon=ft.Icons.CLOSE,
                on_click=lambda e: self.close(self.settings_dialog)
            )
        ]
